...
<!-- Mirrored from wphix.com/template/dukamarket/dukamarket/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Nov 2023 12:06:59 GMT -->
<head>
      <meta charset="utf-8">
                            ...
                            <div class="header-inner-end text-md-end">
                                <div class="ovic-menu-wrapper">
                                    <ul>
                                        ...
                                        <li><a href="index.php?act=contact">Order Tracking</a></li>
                                        <li><a href="index.php?act=contact">Contact Us</a></li>
                                        <li><a href="index.php?act=faq">FAQs</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                  ...
                                                  <div class="cart__item d-flex justify-content-between align-items-center">
                                                    <div class="cart__inner d-flex">
                                                      ...
                                                      <div class="cart__details">
                                                        <h6><a href="index.php?act=product"> Samsung C49J89: £875, Debenhams Plus  </a></h6>
                            ...
                            <div class="cat-toggle">
                                ...
                                <div class="cat__menu">
                                    <nav id="mobile-menu" style="display: block;">
                                        <ul>
                                            <li>
                                                <a href="index.php?act=shop">All Categories <i class="far fa-angle-down"></i></a>
                                                <ul class="mega-menu">
                                                    <li><a href="index.php?act=shop">Shop Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="index.php?act=product">Standard SHop Page</a></li>
                                                            <li><a href="index.php?act=product">Shop Right Sidebar</a></li>
                                                            <li><a href="index.php?act=product">Shop Left Sidebar</a></li>
                                                            <li><a href="index.php?act=product">Shop 3 Column</a></li>
                                                            <li><a href="index.php?act=product">Shop 4 Column</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="index.php?act=shop">Product Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="index.php?act=product">Product Details</a></li>
                                                            <li><a href="index.php?act=product">Product V2</a></li>
                                                            <li><a href="index.php?act=product">Product V3</a></li>
                                                            <li><a href="index.php?act=product">Varriable Product</a></li>
                                                            <li><a href="index.php?act=product">External Product</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="index.php?act=shop">Other Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="index.php?act=product">wishlist</a></li>
                                                            <li><a href="index.php?act=product">Shopping Cart</a></li>
                                                            <li><a href="index.php?act=product">Checkout</a></li>
                                                            <li><a href="index.php?act=product">Login</a></li>
                                                            <li><a href="index.php?act=product">Register</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="index.php?act=shop">Phone &amp; Tablets</a>
                                                        <ul class="mega-item">
                                                            <li><a href="index.php?act=product">Catagory 1</a></li>
                                                            <li><a href="index.php?act=product">Catagory 2</a></li>
                                                            <li><a href="index.php?act=product">Catagory 3</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="index.php?act=shop">Phone &amp; Tablets</a>
                                                        <ul class="mega-item">
                                            ...
                                            <li>
                                                <a href="index.php?act=shop">Phone and Electronics <i class="far fa-angle-down"></i></a>
                                            ...
                                            <li>
                                                <a href="index.php?act=shop">Best Seller Products
                                            ...
                                            <li>
                                                <a href="index.php?act=shop">Top 10 Offers
                                                    <span class="cat-label green">new!</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index.php?act=shop">New Arrivals <i class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="index.php?act=shop">Home Appliances</a></li>
                                                    <li><a href="index.php?act=shop">Technology</a>
                                                        <ul class="submenu">
                                                            <li><a href="index.php?act=shop">Storage Devices</a></li>
                                                            <li><a href="index.php?act=shop">Monitors</a></li>
                                                            <li><a href="index.php?act=shop">Laptops</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="index.php?act=shop">Office Equipments</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="index.php?act=shop">TV &amp; Audio</a></li>
                                            <li><a href="index.php?act=shop">Electronics &amp; Digital</a></li>
                                            <li class="d-laptop-none"><a href="index.php?act=shop">Fashion &amp; Clothings</a></li>
                                            <li class="d-laptop-none"><a href="index.php?act=shop">Jewelry &amp; Watches</a></li>
                                            <li><a href="index.php?act=shop">Health &amp; Beauty</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                      ...
                      <div class="header__bottom-left d-flex d-xl-block align-items-center">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="index.php" class="active">Home <i class="far fa-angle-down"></i></a>
                                        <!-- <ul class="megamenu-1">
                                            ...
                                            <li><a href="index.php?act=shop">Phone &amp; Tablets</a>
                                                <ul class="mega-item">
                                                    ...
                                                    <li><a href="index.php?act=product">Catagory 2</a></li>
                                                    <li><a href="index.php?act=product">Catagory 3</a></li>
                                                    <li><a href="index.php?act=product">Catagory 4</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="index.php?act=shop">Phone &amp; Tablets</a>
                                                <ul class="mega-item">
                                    ...
                                    <li><a href="index.php?act=about">About Us</a></li>
                                    <li class="has-mega"><a href="index.php?act=shop">Shop <i class="far fa-angle-down"></i></a>
                                        <div class="mega-menu">
                                            <div class="container container-mega">
                                                <ul>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="index.php?act=shop">SHOP LAYOUT</a></li>
                                                        <li><a href="index.php?act=shop">Pagination</a></li>
                                                        <li><a href="index.php?act=shop">Ajax Load More</a></li>
                                                        <li><a href="index.php?act=shop">Infinite Scroll</a></li>
                                                        <li><a href="index.php?act=shop">Sidebar Right</a></li>
                                                        <li><a href="index.php?act=shop">Sidebar Left</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="index.php?act=shop">SHOP PAGES</a></li>
                                                        <li><a href="index.php?act=shop">List View</a></li>
                                                        <li><a href="index.php?act=shop">Small Products</a></li>
                                                        <li><a href="index.php?act=shop">Large Products</a></li>
                                                        <li><a href="index.php?act=shop">Shop — 3 Items</a></li>
                                                        <li><a href="index.php?act=shop">Shop — 4 Items</a></li>
                                                        <li><a href="index.php?act=shop">Shop — 5 Items</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="index.php?act=shop">PRODUCT LAYOUT</a></li>
                                                        <li><a href="index.php?act=shop">Description Sticky</a></li>
                                                        <li><a href="index.php?act=shop">Product Carousel</a></li>
                                                        <li><a href="index.php?act=shop">Gallery Modern</a></li>
                                                        <li><a href="index.php?act=shop">Thumbnail Left</a></li>
                                                        <li><a href="index.php?act=shop">Thumbnail Right</a></li>
                                                        <li><a href="index.php?act=shop">Thumbnail Botttom</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="index.php?act=shop">Basketball</a></li>
                                                        <li><a href="index.php?act=shop">East Hampton Fleece</a></li>
                                                        <li><a href="index.php?act=shop">Faxon Canvas Low</a></li>
                                                        <li><a href="index.php?act=shop">Habitasse Dictumst</a></li>
                                                        <li><a href="index.php?act=shop">Kaoreet Lobortis</a></li>
                                                        <li><a href="index.php?act=shop">NikeCourt Zoom</a></li>
                                                        <li><a href="index.php?act=shop">NikeCourts Air Zoom</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                    ...
                                    <li><a href="index.php?act=blog">Blog <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="index.php?act=about">Pages <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            <li><a href="index.php?act=my-account">My Account</a></li>
                                            <li><a href="index.php?act=product">Product Details</a></li>
                                            <li><a href="index.php?act=faq">FAQs pages</a></li>
                                            ...
                                            <li><a href="index.php?act=contact">Contact Us</a></li>
                                            <li><a href="index.php?act=404">404 Error</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
